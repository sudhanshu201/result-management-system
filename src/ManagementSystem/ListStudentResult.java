...
public class ListStudentResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 30, 640, 140));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        // TODO add your handling code here:
         try{
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM result ORDER BY result DESC"); //first result is table name, second result is column name.
